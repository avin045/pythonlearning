 ...
 * print(a+b)
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_a, __pyx_int_1) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 * print(a+b)
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_b, __pyx_int_2) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_builtin_print, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
